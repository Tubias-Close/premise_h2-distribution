...
* **Hydrogen**, when hydrogen audit events exist -- demand nodes, distribution
  shares (including ammonia shipping and on-site production), and consumer
  relinking records with the old and new suppliers and correction reasons.
